 ...
 *   UA international passport (ID-3 booklet/card): 2 letters + 6 digits, e.g. PASSPORT-REDACTED
...
export const DOC_NUMBER_FORMATS: Record<DocNumberKind, RegExp> = {
  // 2 letters (Latin or Cyrillic look-alike) + 6 digits, e.g. PASSPORT-REDACTED
 ...
 *
 * @example
 *   validateDocNumber('ua_intl_passport', 'PASSPORT-REDACTED')      // { valid:true, normalized:'PASSPORT-REDACTED' }
