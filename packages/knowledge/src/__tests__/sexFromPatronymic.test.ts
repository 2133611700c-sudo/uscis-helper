...
eq(sexFromPatronymic('Тимофеевич'), 'M', 'RU Тимофеевич → M (-еевич; closes a sex MISS)')
eq(sexFromPatronymic('Богданович'), 'M', 'RU Богданович → M')
eq(sexFromPatronymic('Андрійович'), 'M', 'UA Андрійович → M')
...
eq(sexFromPatronymic('Петровна'), 'F', 'RU Петровна → F')
eq(sexFromPatronymic('Тимофеевна'), 'F', 'RU Тимофеевна → F')
eq(sexFromPatronymic('Андріївна'), 'F', 'UA Андріївна → F')
...
eq(sexFromPatronymic('Соловьяк'), null, 'surname → null')
...
eq(sexFromPatronymic('  ТИМОФЕЕВИЧ  '), 'M', 'uppercase + spaces')
