...
assert(validateDocNumber('ua_intl_passport', 'PASSPORT-REDACTED').valid === true, 'UA passport PASSPORT-REDACTED valid');
assert(validateDocNumber('ua_intl_passport', 'fu262473').normalized === 'PASSPORT-REDACTED', 'UA passport uppercased');
assert(validateDocNumber('ua_intl_passport', 'F U262473').normalized === 'PASSPORT-REDACTED', 'UA passport strips spaces');
...
assert(validateDocNumber('ua_intl_passport', 'PASSPORT-REDACTED3').valid === false, 'UA passport 7 digits rejected');
