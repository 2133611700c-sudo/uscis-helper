...
# Parse faqAnswers.ts
content = open('/Users/sergiiredacted/work/uscis-helper/apps/web/src/data/faqAnswers.ts').read()
...
# Load env
env = {}
with open('/Users/sergiiredacted/work/uscis-helper/.env.local') as f:
    for line in f:
        line = line.strip()
