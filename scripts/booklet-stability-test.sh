...
IMAGE="/Users/sergiiredacted/work/uscis-helper/qa-shots/private/booklet_test_resized.jpg"
RUNS="${2:-10}"
OUT_DIR="/Users/sergiiredacted/work/uscis-helper/reports/booklet-stability-$(date +%Y%m%d-%H%M%S)"
