...
You are an AI agent executing a task from the Messenginfo project. Six tasks exist in `/Users/sergiikuropiatnyk/work/uscis-helper/tasks/` (or wherever the user dropped them):
...
- Modifying `/Users/sergiikuropiatnyk/handy-friend-landing-v6` (read-only)
- Modifying `/Users/sergiikuropiatnyk/work/messenginfo-merge` (read-only)
