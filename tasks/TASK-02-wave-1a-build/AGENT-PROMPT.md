...
cp /Users/sergiikuropiatnyk/work/uscis-helper/TASK-02-wave-1a-build/data/service-cards.ts.template apps/web/data/serviceCards.ts
```
...
- Do NOT modify `/Users/sergiikuropiatnyk/handy-friend-landing-v6` (read-only reference)
- Do NOT modify `/Users/sergiikuropiatnyk/work/messenginfo-merge` (read-only reference)
