...
- Family name and patronymic recovered via dual-OCR crossref BECAUSE one engine got most of the letters right and the other complemented it (Vision read `"Кулоп'ятник"`, DocAI read `"Куронятник"`, crossref hybrid = `"Куроп'ятник"`).
