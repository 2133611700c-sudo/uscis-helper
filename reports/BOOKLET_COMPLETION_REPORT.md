...
| Ground truth: surname | Куроп'ятник |
...
|-------|-----------|-----------|-------------------|----------|-------------|-------------|--------|---------|
| family_name | (garbled handwritten) | (garbled handwritten) | Куроп'ятник (medium) | ALLOWED | pass-through (no rule) | Куроп'ятник | review=true | ✅ CORRECT |
...
Example from prompt: Vision reads "Кулоп'ятник" + DocAI reads "Куронятник" → hybrid = "Куроп'ятник".
This works because "п'ятник" is a valid Ukrainian morpheme (from "п'ять" = five).

**Live before/after:**
- Before (single OCR): garbled / garbage / wrong value
- After (dual OCR crossref): `Куроп'ятник` — correct, 10/10 stable
...
|-----|---------|------|----------|------------|----------|--------|---------|
| 1 | Куроп'ятник | Trostianets | Vinnytsia Oblast | Serhiiovych | crossref_ok | 4 | 16,748ms |
| 2 | Куроп'ятник | Trostianets | Vinnytsia Oblast | Serhiiovych | crossref_ok | 4 | 17,162ms |
| 3 | Куроп'ятник | Trostianets | Vinnytsia Oblast | Serhiiovych | crossref_ok | 4 | 16,528ms |
| 4 | Куроп'ятник | Trostianets | Vinnytsia Oblast | Serhiiovych | crossref_ok | 4 | 16,996ms |
| 5 | Куроп'ятник | Trostianets | Vinnytsia Oblast | Serhiiovych | crossref_ok | 4 | 16,427ms |
| 6 | Куроп'ятник | Trostianets | Vinnytsia Oblast | Serhiiovych | crossref_ok | 4 | 17,929ms |
| 7 | Куроп'ятник | Trostianets | Vinnytsia Oblast | Serhiiovych | crossref_ok | 4 | 16,132ms |
| 8 | Куроп'ятник | Trostianets | Vinnytsia Oblast | Serhiiovych | crossref_ok | 4 | 17,513ms |
| 9 | Куроп'ятник | Trostianets | Vinnytsia Oblast | Serhiiovych | crossref_ok | 4 | 16,481ms |
| 10 | Куроп'ятник | Trostianets | Vinnytsia Oblast | Serhiiovych | crossref_ok | 4 | 16,578ms |
...
Result: crossref_ok, 15,178ms
  family_name: Куроп'ятник (review=true, src=dual_ocr_crossref, conf=0.7)
