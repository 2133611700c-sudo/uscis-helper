...
const DOCS = [
  {
    file: 'internal_passport_kuropiatnyk.jpg', label: 'PASSPORT (printed + MRZ)',
    fields: ['surname', 'given_name', 'date_of_birth', 'passport_no', 'birth_place'],
    truth: { surname: "Куроп'ятник", given_name: 'Сергій', date_of_birth: '1986-06-25', passport_no: 'PASSPORT-REDACTED', birth_place: 'Вінницька' },
  },
  {
    file: 'birth_cert_soviet_kuropiatnyk.jpg', label: 'BIRTH CERT (handwritten, UkrSSR 1986)',
  ...
  {
    file: 'military_id_p1_kuropiatnyk.jpg', label: 'MILITARY ID (printed + handwritten)',
