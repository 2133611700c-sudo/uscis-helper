 ...
 * sample and verifies that family_name="Kuropiatnyk" actually reaches
 ...
 *   - At step 5, byte-grep the DOM for "Kuropiatnyk".
 *
 * Pass criterion: review DOM contains the string "Kuropiatnyk".
 * The string is the KMU-55 transliteration of "Куроп'ятник" and only
...
const EXPECTED_FAMILY_NAME = 'Kuropiatnyk' // KMU-55 transliteration of "Куроп'ятник"
