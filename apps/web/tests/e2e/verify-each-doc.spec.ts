...
const PASSPORT = path.join(REPO_ROOT, 'qa-shots/private/Passport Sergii Kuropiatnyk .jpg')
const I94 = path.join(REPO_ROOT, 'qa-shots/private/I94 Sergii Kuropiatnyk .jpg')
...
test('4. All 3 docs → Step 5 has given_name edit btn, no blank manual identity inputs', async ({ page }) => {
  ...
  await expect(page.locator('body')).toContainText('Kuropiatnyk', { timeout: 60_000 })
