...
const T = {
  uk: {
    ...
    calloutItems: [
      '· <strong>Частина 2, Пункт 1.e</strong> — Виберіть «Re-Parole» як підставу для заявки.',
  ...
  ru: {
    ...
    calloutItems: [
      '· <strong>Часть 2, Пункт 1.e</strong> — Выберите «Re-Parole» как основание для заявки.',
