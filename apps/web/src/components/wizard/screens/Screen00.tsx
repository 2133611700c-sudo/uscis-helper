...
const T = {
  uk: {
    ...
    subtitle: 'Завантажте паспорт та I-94 — ми заповнимо форму I-131 та підготуємо повний пакет документів для подачі.',
  ...
  ru: {
    ...
    subtitle: 'Загрузите паспорт и I-94 — мы заполним форму I-131 и подготовим полный пакет документов.',
  ...
  en: {
    ...
    title: 'Re-Parole for',
    subtitle: 'Upload your passport and I-94 — we extract the data, fill Form I-131, and prepare a complete document packet for download.',
  ...
  es: {
    ...
    subtitle: 'Suba su pasaporte e I-94 — extraemos los datos, completamos el Formulario I-131 y preparamos el paquete de documentos.',
