    ...
    <>
      ...
      {PH_KEY && (
        <Script id="posthog-init" strategy="afterInteractive">
          ...
          posthog.init('${PH_KEY}',{api_host:'${PH_HOST}',person_profiles:'identified_only',capture_pageview:true,capture_pageleave:true,session_recording:{maskAllInputs:false,maskInputOptions:{password:true}}});`}
        </Script>
      )}
    </>
  )
