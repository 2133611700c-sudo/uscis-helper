...
export function TranslationSamplePreview({ locale }: { locale: string }) {
  const text = {
    uk: {
      ...
      cert: 'Блок сертифікації',
      certBody: '[Текст сертифікації перекладача — заповнюється автоматично у вашому файлі]',
    ...
    ru: {
      ...
      cert: 'Блок сертификации',
      certBody: '[Текст сертификации переводчика — заполняется автоматически в вашем файле]',
    ...
    es: {
      ...
      certBody: '[Texto de certificación del traductor — se genera automáticamente en su archivo]',
    ...
    en: {
      ...
      cert: 'Certification block',
      certBody: '[Translator certification text — auto-generated in your downloaded file]',
