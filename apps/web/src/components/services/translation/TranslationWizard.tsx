...
const UI: Record<string, Record<string, string>> = {
  en: {
    ...
    confirm3: 'I understand I am signing this certification statement myself, and that this is a self-certified template — not prepared by a notary or attorney',
    disclaimer: 'This translation template meets USCIS requirements under 8 CFR 103.2(b)(3) — you print, sign the certification, and submit. This service is not legal advice, an attorney, or an immigration consultant.',
    ...
    next3: 'Include signed certification + your translation + copy of original document',
  ...
  uk: {
    ...
    confirm3: 'Я розумію, що я сам підписую шаблон підтвердження — це не нотаріально завірений переклад',
    disclaimer: 'Цей шаблон перекладу відповідає вимогам USCIS згідно з 8 CFR 103.2(b)(3) — роздрукуйте, підпишіть підтвердження і подайте. Сервіс не є юридичною консультацією, адвокатом або імміграційним консультантом.',
    paymentTitle: 'Оформлення замовлення',
    paymentDisabled: '🆓 Сервіс у бета-режимі — завантажте безкоштовно поки ми визначаємо ціни.',
    paymentPrice: 'Запланована ціна після запуску: $15 / документ.',
    paymentContinue: 'Завантажити безкоштовно →',
    download: 'Завантажити переклад (.html)',
    ...
    next3: 'Вкладіть підписаний шаблон + переклад + копію оригіналу',
    ...
    reviewAsk: 'Цей шаблон перекладу готовий до подачі?',
    reviewBtn: 'Залишити відгук',
    priceBadge: 'Запланована ціна після запуску:',
    wyg1: 'Переклад документа (HTML, друкується)',
  ...
  ru: {
    ...
    confirm3: 'Я понимаю, что я сам подписываю шаблон подтверждения — это не нотариально заверенный перевод',
    disclaimer: 'Этот шаблон перевода соответствует требованиям USCIS согласно 8 CFR 103.2(b)(3) — распечатайте, подпишите подтверждение и подайте. Сервис не является юридической консультацией, адвокатом или иммиграционным консультантом.',
    paymentTitle: 'Оформление заказа',
    paymentDisabled: '🆓 Сервис в бета-режиме — скачайте бесплатно пока мы определяем цены.',
    paymentPrice: 'Запланированная цена после запуска: $15 / документ.',
    paymentContinue: 'Скачать бесплатно →',
    download: 'Скачать перевод (.html)',
    ...
    next3: 'Вложите подписанный шаблон + перевод + копию оригинала',
    ...
    reviewAsk: 'Этот шаблон перевода готов к подаче?',
    reviewBtn: 'Оставить отзыв',
    priceBadge: 'Запланированная цена после запуска:',
    wyg1: 'Перевод документа (HTML, для печати)',
  ...
  es: {
    ...
    confirm3: 'Entiendo que yo mismo firmo esta declaración de certificación — no es una traducción notariada ni preparada por un abogado',
    disclaimer: 'Esta plantilla de traducción cumple con los requisitos de USCIS según 8 CFR 103.2(b)(3) — imprima, firme la certificación y presente. Este servicio no es asesoramiento legal, abogado o consultor de inmigración.',
    paymentTitle: 'Complete su pedido',
    paymentDisabled: '🆓 Servicio en beta — descargue gratis mientras finalizamos los precios.',
    paymentPrice: 'Precio planificado después del lanzamiento: $15 / documento.',
    paymentContinue: 'Descargar gratis →',
    download: 'Descargar traducción (.html)',
    ...
    next3: 'Incluya la plantilla firmada + su traducción + copia del documento original',
    ...
    file1Label: 'Traducción del documento',
    ...
    reviewAsk: '¿Este documento de traducción estaba listo para presentar?',
    reviewBtn: 'Dejar una reseña',
    priceBadge: 'Precio planificado después del lanzamiento:',
    wyg1: 'Traducción del documento (HTML, imprimible)',
...
<p style="font-size:12px;background:#eff6ff;border:1px solid #93c5fd;padding:8px 12px;border-radius:4px">✓ USCIS-compliant translation template per 8 CFR 103.2(b)(3). Sign the accompanying Certification Statement before submitting.</p>
