...
const T = {
  uk: {
    ...
    metaDesc: 'Підготуйте відповіді та докази для подання TPS Ukraine (Form I-821, I-765, I-912). Ви подаєте самостійно через USCIS. Не юридична консультація.',
    badge: 'TPS Україна — продовжено до 19 жовтня 2026',
    title: 'TPS для України',
    subtitle: 'Допоможемо підготувати відповіді, докази та інструкцію для подання TPS до USCIS — крок за кроком.',
    ...
    howSteps: [
      ...
      { num: '2', title: 'Отримайте інструкцію', desc: 'Чек-лист доказів, інструкція що куди вписати у форми I-821 / I-765 / I-912, посилання на офіційні поля USCIS.' },
    ...
    priceServiceDesc: 'Підготовка відповідей, чек-листу та інструкції TPS',
    priceRows: [
  ...
  ru: {
    ...
    metaDesc: 'Подготовьте ответы и доказательства для подачи TPS Ukraine (Form I-821, I-765, I-912). Вы подаёте сами через USCIS. Не юридическая консультация.',
    badge: 'TPS Украина — продлено до 19 октября 2026',
    title: 'TPS для Украины',
    subtitle: 'Поможем подготовить ответы, доказательства и инструкцию для подачи TPS в USCIS — шаг за шагом.',
    ...
    howSteps: [
      ...
      { num: '2', title: 'Получите инструкцию', desc: 'Чек-лист доказательств, инструкция что куда вписывать в I-821 / I-765 / I-912, ссылки на официальные поля USCIS.' },
    ...
    priceServiceDesc: 'Подготовка ответов, чек-листа и инструкции TPS',
    priceRows: [
  ...
  en: {
    ...
    metaDesc: 'Prepare your answers and evidence for filing TPS Ukraine (Form I-821, I-765, I-912). You file with USCIS yourself. Not legal advice.',
    badge: 'TPS Ukraine — extended through Oct 19, 2026',
    title: 'TPS for Ukraine',
    subtitle: 'We help you prepare answers, evidence, and a transfer guide for filing TPS with USCIS — step by step.',
    ...
    priceServiceDesc: 'TPS answers, checklist, and transfer guide',
    priceRows: [
  ...
  es: {
    ...
    metaDesc: 'Prepare sus respuestas y evidencias para presentar TPS Ucrania (Form I-821, I-765, I-912). Usted presenta ante USCIS. No es asesoramiento legal.',
    badge: 'TPS Ucrania — extendido hasta 19 oct 2026',
    title: 'TPS para Ucrania',
    subtitle: 'Le ayudamos a preparar respuestas, evidencias y una guía de transferencia para presentar TPS ante USCIS — paso a paso.',
