...
const COPY = {
  uk: {
    ...
    nsSignPenWarning: '⚠ ПІДПИС від руки — обов\'язково! (FR 2026-09289, з 10.07.2026): USCIS може ВІДХИЛИТИ заяву та УТРИМАТИ збір за недійсний підпис (скан/фото, надрукований текст, програмний). Підписуйте вручну на роздрукованому папері чорною або синьою ручкою. Виправлення не допускається.',
  ...
  ru: {
    ...
    nsSignPenWarning: '⚠ ПОДПИСЬ от руки — обязательно! (FR 2026-09289, с 10.07.2026): USCIS может ОТКЛОНИТЬ заявление и УДЕРЖАТЬ сбор за недействительную подпись (скан/фото, напечатанный текст, программный). Подписывайте вручную на распечатанной бумаге чёрной или синей ручкой. Исправление не допускается.',
  ...
  en: {
    ...
    nsSignPenWarning: '⚠ HANDWRITTEN signature required! (FR doc 2026-09289, effective July 10, 2026): USCIS may DENY your application and KEEP your filing fee for an invalid signature (scanned image, typed name, software-generated). Sign BY HAND on the printed paper in black or blue ink. No cure is allowed.',
  ...
  es: {
    ...
    nsSignPenWarning: '⚠ Firma MANUSCRITA obligatoria (FR doc 2026-09289, vigente 10 jul 2026): USCIS puede DENEGAR la solicitud y RETENER la tarifa por firma inválida (imagen escaneada, nombre escrito, software). Firme A MANO en el papel impreso con tinta azul o negra. No se permite corrección.',
