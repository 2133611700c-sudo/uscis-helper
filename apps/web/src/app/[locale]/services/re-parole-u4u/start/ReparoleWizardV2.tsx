...
const T = {
  uk: {
    ...
    s1FeeWarn: '⚠️ Fee waiver (I-912) — тільки поштою. Parole fee $1,020 НЕ підлягає waiver.',
  ...
  ru: {
    ...
    s1FeeWarn: '⚠️ Fee waiver (I-912) — только почтой. Parole fee $1,020 НЕ подлежит waiver.',
  ...
  en: {
    ...
    s1FeeWarn: '⚠️ Fee waiver (I-912) — paper filing only. The $1,020 parole fee is NOT waivable.',
  ...
  es: {
    ...
    s1FeeWarn: '⚠️ Fee waiver (I-912) — solo correo. La tarifa de parole de $1,020 NO es renunciable.',
