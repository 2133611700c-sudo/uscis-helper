...
describe('formatDateEn', () => {
  ...
  it('numeric DD.MM.YYYY', () => expect(formatDateEn('25.06.1986')).toBe('25 June 1986'))
  it('ISO', () => expect(formatDateEn('1986-06-25')).toBe('25 June 1986'))
...
describe('translateAuthority — glossary with historical locks', () => {
  ...
  it('civil registry ЗАГС → Civil status authority', () => {
    expect(translateAuthority('Тростянецький районний відділ ЗАГС')).toMatch(/civil/i)
  })
