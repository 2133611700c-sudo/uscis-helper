...
function buildReadme(
  ...
  return [
    ...
    '     *** SIGNATURE WARNING (Federal Register doc 2026-09289, effective 2026-07-10) ***',
    '     USCIS may DENY your application AND RETAIN YOUR FILING FEE if it later finds',
    '     an invalid signature. Invalid = copy-pasted image, typed name, software-generated,',
    '     or stamped. You must sign BY HAND on the printed paper. No cure is allowed.',
