...
/** Translation price as a display string (e.g. "$15.00"). */
export const TRANSLATION_PRICE_DISPLAY = '$15.00' as const

/** Translation price as a short display string (e.g. "$15"). */
export const TRANSLATION_PRICE_SHORT = '$15' as const
