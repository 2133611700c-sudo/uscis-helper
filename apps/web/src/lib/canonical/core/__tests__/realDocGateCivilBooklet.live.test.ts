...
const DOCS: RealDocSpec[] = [
  {
    ...
    image: 'internal_passport_redacted.jpg',
    gt: 'internal_passport_redacted.json',
  ...
  },
  {
    ...
    image: 'birth_cert_handwritten_redacted.jpg',
    gt: 'birth_cert_handwritten_redacted.json',
  ...
  },
  {
    ...
    documentClass: 'ua_birth_certificate',
    image: 'birth_cert_soviet_redacted.jpg',
    gt: 'birth_cert_soviet_redacted.json',
    docTypeId: 'ua_birth_certificate',
    fields: [
      { canonicalKey: 'child_family_name', gtKey: 'family_name_cyrillic', compare: 'cyrillic', mustReview: true },
      { canonicalKey: 'child_given_name', gtKey: 'given_name_cyrillic', compare: 'cyrillic', mustReview: true },
  ...
  },
  {
    ...
    image: 'military_id_p1_redacted.jpg',
    gt: 'military_id_p1_redacted.json',
