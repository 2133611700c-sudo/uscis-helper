...
export const serviceCards: ServiceCard[] = [
  ...
  { id: 're-parole-u4u', slug: 're-parole-u4u', icon: ShieldCheck, image: '/service-icons/re-parole-u4u.webp', hasOfficialSource: true, officialSourceUrl: 'https://www.uscis.gov/humanitarian/uniting-for-ukraine', sourceLastVerified: '2026-04-29', sortOrder: 2 },
  ...
  { id: 'ead-work-permit', slug: 'ead-work-permit', icon: IdCard, image: '/service-icons/work-permit.webp', hasOfficialSource: true, officialSourceUrl: 'https://www.uscis.gov/i-765', sourceLastVerified: '2026-04-29', sortOrder: 4 },
