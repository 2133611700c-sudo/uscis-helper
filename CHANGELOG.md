...
**Live E2E extended (3 docs):** pipeline.live.e2e now covers military + international passport (MRZ controlling-Latin: REDACTED/PASSPORT-REDACTED) + handwritten 1986 birth cert. All PASS live — no new bugs. Gated (LIVE_E2E=1), skips in CI.
...
- `pdftotext` readback proves key fields present in generated PDFs (`REDACTED`, `PASSPORT-REDACTED`, `UHP`, `Los Angeles`, `90029`).
