...
**Live E2E extended (3 docs):** pipeline.live.e2e now covers military + international passport (MRZ controlling-Latin: KUROPIATNYK/PASSPORT-REDACTED) + handwritten 1986 birth cert. All PASS live — no new bugs. Gated (LIVE_E2E=1), skips in CI.
...
- `apps/web/tests/e2e/booklet-only-pdf-proof.spec.ts`:
  - Added `passport_number` (PASSPORT-REDACTED) fill as MANUAL_GATING_ONLY.
...
- `pdftotext` readback proves key fields present in generated PDFs (`Kuropiatnyk`, `PASSPORT-REDACTED`, `UHP`, `Los Angeles`, `90029`).
...
## 2026-06-03 | fix: wire military_id + birth_certificate modules into TPS route
- Added imports: runMilitaryIdModule, runBirthCertificateModule to route.ts
