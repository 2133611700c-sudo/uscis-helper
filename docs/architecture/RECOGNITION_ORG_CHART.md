...
`test-fixtures/real-docs/` (gitignored — PII): 9 documents, multiple distinct people — marriage (Zastavnyi/Kovshirina, 1939 Borodavka, Johnson/Kvasnikova, apostille), divorce (blank + redacted), birth (REDACTED handwritten), military ID (REDACTED). This breaks the N=1 self-deception. Every accuracy claim must be measured against owner-confirmed ground truth on this set.
