...
Generated: 2026-05-16T07:38:47.073Z

WHAT THIS IS
  Two PDFs prefilled with the data you typed into the wizard:
    I-821 (Application for TPS) — edition 01/20/25, 123 AcroForm cells written
    I-765 (Application for EAD) — edition 08/21/25, 38 AcroForm cells written, category (a)(12)
...
WHERE TO MAIL (resolved for state: CA)
  ...
  Source: https://www.uscis.gov/humanitarian/temporary-protected-status/TPS-Ukraine
  Snapshot date: 2026-05-12. Verify before mailing — addresses can change.

GOVERNMENT FEES (verify current amounts on uscis.gov before mailing)
  • I-821 — TPS application
    https://www.uscis.gov/g-1055?form=I-821
  • biometrics — Biometrics may apply (age 14+ generally)
    https://www.uscis.gov/g-1055
  • I-765 — Work permit (Employment Authorization Document)
    https://www.uscis.gov/g-1055?form=I-765
  Note: The exact dollar amounts can change. Always verify the current fee on the official USCIS Fee Schedule (G-1055) before mailing: https://www.uscis.gov/g-1055
  Note: EAD VALIDITY RULE (H.R.1, effective 2026-05-29): TPS-based EADs issued or renewed on or after 2026-05-29 are valid for 1 year (or remaining TPS period, whichever is shorter). Verify current EAD validity rules on the official USCIS TPS Ukraine page.
...
SOURCE FORMS
  ...
  uscis.gov pages and PDF footer edition stamps on 2026-05-12.
  Official TPS Ukraine page: https://www.uscis.gov/humanitarian/temporary-protected-status/TPS-Ukraine
