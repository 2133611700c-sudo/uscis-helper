...
- It **newly added 34 `I-821.txt` evidence dumps** (parent tree had 0). These are filled USCIS forms containing the owner's real PII — e.g. `(Last Name) REDACTED` — plus I-765 dumps, OCR network JSON, owner-status JSON.
