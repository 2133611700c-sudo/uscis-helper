...
| #3 | passport name re-transliterated vs MRZ | ✅ PASS | `mrz.test.ts` (REDACTED/SERGII, check digits) + presence override |
...
- [ ] Passport name = MRZ Latin (e.g. REDACTED), not re-transliterated.
