# GT Pipeline Bench — 2026-06-23 · DRY (offline, frozen reads)
...
**Recognition rate: 0.0%** — CORRECT 0 · WRONG 4 · MISS 1 · FABRICATED 0 · empty-ok 0
**AUTO-FILLED correctly (no human): 0/5 = 0.0%** (correct value AND review_required=false)
...
| ua_birth_certificate | 0 | 8 | 2 | 0 | 0 | 0.0% |
| ua_military_id | 4 | 0 | 1 | 0 | 0 | 80.0% |
| **OVERALL** | 7 | 8 | 5 | 0 | 0 | **35.0%** |
