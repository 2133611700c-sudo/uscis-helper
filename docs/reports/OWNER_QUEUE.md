...
- Файлы (шаблоны уже созданы, поля пустые):
  - `test-fixtures/real-docs/ground-truth/birth_cert_handwritten_kuropiatnyk.json`
  - `test-fixtures/real-docs/ground-truth/birth_cert_soviet_kuropiatnyk.json`
  - `test-fixtures/real-docs/ground-truth/military_id_p1_kuropiatnyk.json`
...
- Booklet уже VERIFIED — `qa-private/ground-truth/internal_passport_kuropiatnyk.json` (трогать не надо).
