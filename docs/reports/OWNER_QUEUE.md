...
- Файлы (шаблоны уже созданы, поля пустые):
  - `test-fixtures/real-docs/ground-truth/birth_cert_handwritten_redacted.json`
  - `test-fixtures/real-docs/ground-truth/birth_cert_soviet_redacted.json`
  - `test-fixtures/real-docs/ground-truth/military_id_p1_redacted.json`
...
- Booklet уже VERIFIED — `qa-private/ground-truth/internal_passport_redacted.json` (трогать не надо).
