...
- `INSTANT OWNER OPTION` rename Vercel var `GEMINI_API_KEY_066`→`GEMINI_API_KEY_PAY` (+ optionally CENTRAL_BRAIN_TRANSLATION off → legacy single-read) → prod recognition works without merging. PR not merged; manual approval.
