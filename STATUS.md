...
## spike/pdf-readback (2026-05-29) — ADR-015
- `VERIFIED(local)` Spike: existing pdf-lib bureau renderer gives extractable text → React-PDF NOT needed. ADR-015 accepted. Real gap = field-key mapping + Document Registry, not a renderer.
