...
- Next: 1.3 gate the wiring in 4 routes + readDocumentCore (OFF=identical); 1.4 real-fixture proof with flag ON. Then Phase 2 consolidation (one Core path; remove GPT/legacy forks). Branch feat/one-brain-gemini-core. No prod/keys/PII change.
