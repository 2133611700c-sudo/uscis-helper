...
- Next: 1.4 real-fixture local proof (flag ON); then Phase 2 Core-default per product, built to the contract. Branch feat/one-brain-gemini-core (PR #104). No prod/keys/PII change.
