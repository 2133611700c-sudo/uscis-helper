...
- Next: Phase 2.0 (rawCyrillic → D2) then Phase 2 Core-default per product, built to the contract. Branch feat/one-brain-gemini-core (PR #104). No prod/keys/PII change. Owner verdict honored (contract recorded, runtime HOLD).
