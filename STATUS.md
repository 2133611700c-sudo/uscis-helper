...
- `PROD_REALITY` ALL Core flags + `SMART_NORMALIZE_ENABLED` OFF → none of P2.1/2.2/2.3 affects prod today. "One door for all 4" provable only on flag-gated (non-live) Core paths. Pre-existing Session-103 One-Brain debt.
