...
- 2026-06-11 PIVOT Phase 1 SHIPPED: 504=parallel pages; unread fields backfilled (patronymic visible as manual-entry); review copy softened. OPEN: смт preservation (agent), operator-flow Phases 2-4, PII sweep in 6 test files.
