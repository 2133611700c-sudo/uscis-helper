...
- `CONTRAST` International passport read identically+correctly across models/runs (KUROPIATNYK/PASSPORT-REDACTED/1986-06-25, review=false). Instability is hard-case-specific.
...
- `VERIFIED(live API)` passport MRZ path (KUROPIATNYK/PASSPORT-REDACTED) + handwritten birth cert proven live; 3-doc gated E2E.
...
- `VERIFIED` PDF readback finds core values in generated PDFs:
  - `Kuropiatnyk`, `PASSPORT-REDACTED`, `UHP`, `Los Angeles`, `90029`.
