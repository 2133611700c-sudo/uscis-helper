...
- Next: Phase 2.0 RECONCILE (one dict layer at raw-Cyrillic place) + 2.0b model-id fix; per-class model selection + dict OFF/ON delta = owner-GT-gated. Branch feat/one-brain-gemini-core (PR #104). No prod/keys/PII change.
