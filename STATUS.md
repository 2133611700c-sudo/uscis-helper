...
- 2026-06-11 OPERATOR FLOW CODE-COMPLETE behind NEXT_PUBLIC_NEW_OPERATOR_FLOW_ENABLED (OFF): pay→queue→/order/[id]→admin PDF email. Pending: mentor migration (operator_completed CHECK), owner $1 real test + flag-on decision (needs OPERATOR_SIGNER_NAME/ADDRESS envs).
