...
- SURVIVAL 3A-CORE (visual): ::selection defined (highlighted text readable in dark — owner's main complaint), font tokens wired in @theme (Inter/Playfair, no more system-ui split), Playfair+cyrillic, 4 worst contrast fixes (button hover / MemberTabs / MobileBottomBar / 9px arrow). tsc 0, build clean, 3216 pass.
