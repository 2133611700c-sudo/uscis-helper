...
- Next: 1.4 real-fixture local proof (flag ON, Militsiya/oblast/patronymic/gazetteer); then Phase 2 consolidation (Core default for all products; remove GPT; retire legacy fork). Branch feat/one-brain-gemini-core. No prod/keys/PII change.
