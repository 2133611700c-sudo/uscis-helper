...
- LIVE through the spine (owner booklet): Kuropiatnyk/Serhii/Serhiiovych/1986-06-25/Trostianets/Vinnytsia Oblast. Settlement prefix "с.м.т." (live Gemini variant) correctly stripped → bare city for the form; raw Cyrillic preserved for translation.
...
### Verified
- Unit: KMU-55 → Kuropiatnyk / Serhii / Serhiiovych / Trostianets (exact).
...
### Second issue: OCR misread "Kuropiatnyk" → "Khlopiatnyk"
...
- Removed real-PII placeholders from the LIVE site (Sergii/PASSPORT-REDACTED/06-25-1986/Serhiiovych) + from e2e test files → synthetic values.
