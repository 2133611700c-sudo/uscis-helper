...
- Title-cases ALL-CAPS Latin input (MRZ delivers "REDACTED" → "REDACTED")
- Garbage rejection for both paths

### Result
- Before: booklet-only users got Cyrillic "REDACTED_NAME" in form
- After: booklet-only users get Latin "REDACTED" in form
...
- Passport MRZ regression: family_name=REDACTED preserved (no double-transliteration)
