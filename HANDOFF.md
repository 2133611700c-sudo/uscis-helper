...
## spike/pdf-readback — ADR-015 PDF architecture DONE
Spike proved pdf-lib bureau renderer is text-extractable (golden tests work) → no React-PDF. ADR-015 written. Next (after #26 merge): field-key mapping layer (recognized→schema keys) + Document Registry + flag-gated wiring of renderOfficialTranslation into live generate-pdf + owner visual approval.
