...
**2. PII in git history — needs a yes/no.** Owner's own name / `PASSPORT-REDACTED` / DOB are pervasive in main history
...
4. Later: PII history sweep before sharing the repo externally (surname/`PASSPORT-REDACTED`/DOB pervasive in main
